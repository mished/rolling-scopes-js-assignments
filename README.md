...
## Javascript Assignments  [![Build Status](https://travis-ci.org/mished/rolling-scopes-js-assignments.svg?branch=master)](https://travis-ci.org/mished/rolling-scopes-js-assignments)
...
* Edit local README.md file and update all links (just replace all occurences of `'mished'` with your account name).
...
```
* Open https://github.com/mished/rolling-scopes-js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/mished/rolling-scopes-js-assignments/builds).
